        ...
        <div id="app-sidepanel" class="app-sidepanel sidepanel-hidden"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="/dashboard"><img class="logo-icon me-2" src="https://i.ibb.co/zhrvvPv/masak-mie-1.png" alt="logo"><span class="logo-text">Warmindo Aroma</span></a>
  ...
  <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/>
    ...
    <nav class="app-nav app-nav-footer">
        <ul class="app-menu footer-menu list-unstyled">
            <!-- Item Settings yang sudah ada -->
            <li class="nav-item">
                <!-- Link ke Settings (kode asli) -->
            </li><!--//nav-item-->
			...
			<a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#modalLogoutConfirm">
                    <span class="nav-icon">
                        ...
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-box-arrow-right" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z"/>
                            <path fill-rule="evenodd" d="M10.354 11.354a.5.5 0 0 1 0-.708L13.646 7.5H1.5a.5.5 0 0 1 0-1h12.146l-3.292-3.146a.5.5 0 1 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708 0z"/>
                            <path fill-rule="evenodd" d="M10.5 15a2 2 0 0 1-2-2v-1a2 2 0 0 1 2-2h3.5a.5.5 0 0 1 .5.5V13a2 2 0 0 1-2 2h-3.5z"/>
                        </svg>
                    </span>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalLogoutConfirmLabel">Konfirmasi Logout</h5>
            ...
            <div class="modal-footer">
                ...
                <a href="/logout" class="btn btn-primary">Ya, Logout</a> <!-- Ganti '/logout' dengan URL logout yang sesuai di server Anda -->
            </div>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        const sidebar = document.getElementById('app-nav-main');
        const navLinks = sidebar.querySelectorAll('.nav-link');

        // Mendapatkan path halaman saat ini
        const currentPath = window.location.pathname;

        // Menandai link aktif berdasarkan path halaman
        navLinks.forEach(link => {
            // Menghapus kelas active dari setiap link
            link.classList.remove('active');
            
            // Memeriksa apakah path halaman saat ini cocok dengan path link
